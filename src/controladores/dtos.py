...
def inscripcion_to_dto(inscripcion: InscripcionSocio) -> InscripcionSocioDTO:
    return InscripcionSocioDTO(
        ...
        noSocioNombre=inscripcion.noSocioNombre,
        noSocioApellido1=inscripcion.noSocioApellido1,
        noSocioApellido2=inscripcion.noSocioApellido2,
        noSocioDni=inscripcion.noSocioDni,
